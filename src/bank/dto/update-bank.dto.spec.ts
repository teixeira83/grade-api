...
const importInfo: UpdateBankDto = {
  user: {
    cellphone: '',
    cpf: '227.441.415-77',
    email: 'live@live.com',
...
it('should be defined.', async () => {
  const ofImportDto = plainToInstance(UpdateBankDto, importInfo)
...
it('should throw error when passing user.cellphone incorrect.', async () => {
  ...
  const ofImportDto = plainToInstance(UpdateBankDto, mockDTO)
  const errors = await validate(ofImportDto)
...
it('should throw error when passing bank.code incorrect.', async () => {
  ...
  const errorField: any = errors[1].children.find(item => item['property'] === 'code')
...
it('should throw error when passing bank.sapCode incorrect.', async () => {
  ...
  const errorField: any = errors[1].children.find(item => item['property'] === 'sapCode')
...
it('should throw error when passing bank.name incorrect.', async () => {
  ...
  const errorField: any = errors[1].children.find(item => item['property'] === 'name')
...
it('should throw error when passing bank.corporateName incorrect.', async () => {
  ...
  const errorField: any = errors[1].children.find(item => item['property'] === 'corporateName')
...
it('should throw error when passing bank.email incorrect.', async () => {
  ...
  const errorField: any = errors[1].children.find(item => item['property'] === 'email')
...
it('should throw error when passing bank.emailDomain incorrect.', async () => {
  ...
  const errorField: any = errors[1].children.find(item => item['property'] === 'emailDomain')
...
it('should throw error when passing bank.mainPhone incorrect.', async () => {
  ...
  const errorField: any = errors[1].children.find(item => item['property'] === 'mainPhone')
...
it('should throw error when passing bank.alternatePhone incorrect.', async () => {
  ...
  const errorField: any = errors[1].children.find(item => item['property'] === 'alternatePhone')
...
it('should throw error when passing bank.esg incorrect.', async () => {
  ...
  const errorField: any = errors[1].children.find(item => item['property'] === 'esg')
...
it('should throw error when passing icon.iconId incorrect.', async () => {
  ...
  const errorField: any = errors[2].children.find(item => item['property'] === 'iconId')
